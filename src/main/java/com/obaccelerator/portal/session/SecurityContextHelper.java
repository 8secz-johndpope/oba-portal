...
public class SecurityContextHelper {
    ...
    public static void registerPortalUserWithSpringSecurityContext(PortalUser portalUser) {
        SecurityContextHolder.getContext().setAuthentication(portalUserToToken(portalUser));
    }

    public static UsernamePasswordAuthenticationToken portalUserToToken(PortalUser portalUser) {
